...
@Named("Scenario: Configure Eclipse with Objectium Code Ceanup strategy")
@SuppressWarnings("all")
public class ConfigureEclipseWithCodeQualityPluginsFeatureConfigureEclipseWithObjectiumCodeCeanupStrategy extends ConfigureEclipseWithCodeQualityPluginsFeatureBackground {
  @Test
  @Order(0)
  @Named("When \\\"code_cleanup.xml\\\" is available in \\\"build-tools\\\" project \\\"src/main/resources/configurations\\\" path")
  public void _whenCodeCleanupXmlIsAvailableInBuildToolsProjectSrcMainResourcesConfigurationsPath() {
    StepArguments _stepArguments = new StepArguments("code_cleanup.xml", "build-tools", "src/main/resources/configurations");
  ...
  @Order(1)
  @Ignore
  @Named("Then we can configure the eclipse Java code cleanup by following the steps given below")
  public void _thenWeCanConfigureTheEclipseJavaCodeCleanupByFollowingTheStepsGivenBelow() {
